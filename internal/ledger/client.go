...
type Client interface {
	...
	RaiseDispute(ctx context.Context, id string, userID string) (string, error)
	ResolveDispute(ctx context.Context, id string, payoutToBuyer, payoutToSeller float64, userID string) error
