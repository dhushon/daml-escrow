...
func (c *JsonLedgerClient) CreateInvitation(ctx context.Context, inviterID string, inviteeEmail string, role string, inviteeType string, terms EscrowTerms) (*EscrowInvitation, error) {
	...
	body := map[string]interface{}{
		"commands": map[string]interface{}{
			...
			"actAs":     []string{inviterParty, mediatorParty, cbParty},
			"userId":    inviterID,
			"commands": []interface{}{
	...
	body := map[string]interface{}{
		"commands": map[string]interface{}{
			...
			"commands": []interface{}{
				map[string]interface{}{
					"ExerciseCommand": map[string]interface{}{
						"templateId": fmt.Sprintf("%s:%s:%s", c.InterfacePackageID, "Escrow.Interface", "DisputedEscrow"),
						"contractId": id,
	...
	body := map[string]interface{}{
		"commands": map[string]interface{}{
			...
			"commands": []interface{}{
				map[string]interface{}{
					"ExerciseCommand": map[string]interface{}{
						"templateId": fmt.Sprintf("%s:%s:%s", c.InterfacePackageID, "Escrow.Interface", "Settlement"),
