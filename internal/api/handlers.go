...
func (h *Handler) ClaimInvitation(w http.ResponseWriter, r *http.Request) {
	...
	userID, _ := r.Context().Value(AuthSubKey).(string)
	invite, _ := h.escrowService.GetInvitationByToken(r.Context(), token)
...
func (h *Handler) ListInvitations(w http.ResponseWriter, r *http.Request) {
	userID, _ := r.Context().Value(AuthSubKey).(string)
	invitations, _ := h.escrowService.ListInvitations(r.Context(), userID)
	w.Header().Set("Content-Type", "application/json")
...
func (h *Handler) GetInvitationByToken(w http.ResponseWriter, r *http.Request) {
	token := chi.URLParam(r, "token")
	invitation, _ := h.escrowService.GetInvitationByToken(r.Context(), token)
	w.Header().Set("Content-Type", "application/json")
	json.NewEncoder(w).Encode(invitation)
}
...
func (h *Handler) GetMetrics(w http.ResponseWriter, r *http.Request) {
	userID, _ := r.Context().Value(AuthSubKey).(string)
	metrics, _ := h.escrowService.GetMetrics(r.Context(), userID)
	w.Header().Set("Content-Type", "application/json")
	json.NewEncoder(w).Encode(metrics)
}

func (h *Handler) ListSettlements(w http.ResponseWriter, r *http.Request) {
	settlements, _ := h.escrowService.ListSettlements(r.Context())
	w.Header().Set("Content-Type", "application/json")
...
func (h *Handler) SettlePayment(w http.ResponseWriter, r *http.Request) {
	...
	h.escrowService.SettlePayment(r.Context(), id)
	w.WriteHeader(http.StatusOK)
}

func (h *Handler) ListWallets(w http.ResponseWriter, r *http.Request) {
	userID, _ := r.Context().Value(AuthSubKey).(string)
	wallets, _ := h.escrowService.ListWallets(r.Context(), userID)
	w.Header().Set("Content-Type", "application/json")
